                ...
                <div className="space-y-8">
                    {sections.map((sectionKey, index) => (
                        <div key={index}>
                            ...
                            {sectionKey === 'definitions' ? (
                            ...
                            ) : (sectionKey === 'liability' || sectionKey === 'account') ? (
                                <ol className="list-decimal list-inside space-y-2 text-black">
                                    {t.raw(`sections.${sectionKey}.items`).map((item: string, idx: number) => (
                                        <li
                                            key={idx}
                                            className="text-[16px] leading-[26px] lg:text-[16px] lg:leading-[26px] md:text-[14px] md:leading-[22px] sm:text-[13px] sm:leading-[20px] font-medium"
                                            style={getFontStyles(locale)}
                                ...
                                <>
                                    ...
                                    <ul className="list-disc list-inside space-y-2 text-black">
                                        {t.raw('sections.websiteUse.items').map((item: string, idx: number) => (
                                            <li
                                                key={idx}
                                                className="text-[16px] leading-[26px] lg:text-[16px] lg:leading-[26px] md:text-[14px] md:leading-[22px] sm:text-[13px] sm:leading-[20px] font-medium"
                                                style={getFontStyles(locale)}
