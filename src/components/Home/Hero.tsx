    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-6xl">
          {/* Main Title - LCP Element Optimization */}
          <LocalizedHeading
            level={1}
            ...
            style={{
              ...
              lineHeight: '100%',
              fontWeight: '600',
              willChange: 'auto', // Remove will-change to prevent performance issues
            }}
          >
          ...
          <div className="mt-6 sm:mt-8 md:mt-10 flex">
            <div className="flex sm:flex-row items-center gap-3 sm:gap-4">
              <LocalizedButton
                ...
                className="group flex items-center justify-center gap-2 sm:gap-3 bg-white px-6 py-3 sm:px-8 sm:py-4 text-sm sm:text-base md:text-lg font-semibold text-gray-900 transition-all duration-300 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-900 w-full sm:w-auto min-w-[200px] sm:min-w-[250px] cursor-pointer"
              >
                {t('cta')}
              </LocalizedButton>
              ...
              <LocalizedButton
                onClick={scrollToServices}
                className="group flex items-center justify-center gap-2 sm:gap-3 bg-[#21FE7B] px-6 py-3 sm:px-8 sm:py-4 text-sm sm:text-base md:text-lg font-semibold text-white transition-all duration-300 hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-gray-900 w-auto cursor-pointer"
              >
                <svg
